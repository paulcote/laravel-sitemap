...
<news:name>{{$tag->news['publication']['name']}}</news:name>
@endif
@if(isset($tag->news['publication']['language']))
<news:language>{{$tag->news['publication']['language']}}</news:language>
@endif
</news:publication>
@endif
@if(isset($tag->news['publication_date']))
<news:publication_date>{{$tag->news['publication_date']}}</news:publication_date>
@endif
@if(isset($tag->news['title']))
<news:title>{{$tag->news['title']}}</news:title>
@endif
</news:news>
@endif
</url>